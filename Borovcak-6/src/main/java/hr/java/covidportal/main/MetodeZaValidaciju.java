...
public class MetodeZaValidaciju {
     ...
     */
    protected static void hvatanjeNeoznaceneIznimkeBolestIstihSimptoma(Scanner scan, Set<Simptom> simptomi, Set<Bolest> bolesti, KlinikaZaInfektivneBolesti<Virus, Osoba> klinikaZaInfektivneBolesti, Integer i) {
